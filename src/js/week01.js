        ...
        <tbody>
          {products.map((product) => (
            <tr
              key={product.id}
              className={
                changName && product.id === newProduct.id ? "active" : ""
              }
            >
              <td>{product.name}</td>
              <td>
              ...
              <td>
                <button
                  type="button"
                  onClick={() => patchProducts(product.id, "remove")}
                >
                  -
                </button>
                {product.num}
                <button
                  type="button"
                  onClick={() => patchProducts(product, "add")}
                >
                  +
                </button>
              </td>
              <td>
                <button type="button" onClick={(e) => reName(product, e)}>
                  {changName && product.id === newProduct.id
                    ? "保存"
                    : "修改品項"}
                </button>
              </td>
